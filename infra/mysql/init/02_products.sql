...
('1', 'REVO Morning', 'Hương vị nhẹ nhàng, tinh tế cho buổi sáng đầy năng lượng', 99000.00, 1, 'arabica', 'Cầu Đất, Đà Lạt', '<1000m', 'Washed', 'Washed', 'light', 'Hoa nhài, Cam vàng, Mật ong', '/assets/img/section2/image1.png', 99250, TRUE),
('2', 'REVO Everyday', 'Hương vị cân bằng dịu nhẹ, hậu vị ngọt kéo dài', 139000.00, 2, 'blend', 'Đắk Lắk & Đà Lạt', '1000-2000m', 'Honey', 'Honey', 'medium-dark', 'Chocolate, Hạnh nhân, Caramel', '/assets/img/section2/image2.png', 99749, TRUE),
('3', 'REVO Origin', 'Robusta nguyên bản mạnh mẽ, đậm vị truyền thống', 149000.00, 3, 'robusta', 'Buôn Ma Thuột', '1000-2000m', 'Natural', 'Natural', 'dark', 'Cacao đắng, Gỗ sồi, Hạt dẻ', '/assets/img/section2/image3.png', 99496, TRUE),
('4', 'REVO Đậm Đà', 'Hương vị robusta tuyển chọn với hậu vị sâu lắng', 129000.00, 4, 'fine-robusta', 'Gia Lai', '>2000m', 'Semi Washed', 'Semi Washed', 'medium-dark', 'Socola đen, Mật mía, Hạnh nhân rang', '/assets/img/section2/image4.png', 99000, TRUE),
('5', 'REVO Robusta', 'Robusta cổ điển mạnh mẽ, phù hợp gu Việt', 109000.00, 3, 'robusta', 'Đắk Lắk', '>2000m', 'Natural', 'Natural', 'medium', 'Caramel, Chocolate sữa, Gỗ nhẹ', '/assets/img/section2/image5.png', 99249, TRUE);
